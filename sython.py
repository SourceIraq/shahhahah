...
@sython1.on(events.NewMessage(outgoing=False, pattern='.الاوامر1'))
...
@sython1.on(events.NewMessage(outgoing=False, pattern='.تحكم2'))
...
@sython1.on(events.NewMessage(outgoing=True, pattern=".الاوامر2"))
